...
//    QuerySnapshot aSnap = await fire.collection("cars").getDocuments();
//    var ok = aSnap.documents;
//  }
//
...
//            children: <Widget>[
//              Expanded(
//                child: Text(snapshot.data.documents[documentName][fieldName]),
//              ),
//              Expanded(
//                child: Text(snapshot.data.documents[documentName][fieldName]),
//              ),
...
//          leading: Container(
//            child: Icon(Icons.directions_car, size: 25.5,),
//          )
//        ),
//      ),
//    ]));
